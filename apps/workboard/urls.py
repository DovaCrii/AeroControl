...
urlpatterns = [
    ...
    path(
        "reports/tasks.csv", views.TaskReportCsvView.as_view(), name="task-report-csv"
    ),
    path(
        "reports/tasks.xlsx",
        views.TaskReportXlsxView.as_view(),
        name="task-report-xlsx",
    ),
    path(
        "reports/tasks.docx",
        views.TaskReportDocxView.as_view(),
        name="task-report-docx",
    ),
    ...
    path(
        "tasks/<uuid:pk>/archive/", views.TaskArchiveView.as_view(), name="task-archive"
    ),
    ...
    path(
        "tasks/<uuid:pk>/checklist/",
        views.ChecklistItemCreate.as_view(),
        name="checklist-create",
    ),
    path(
        "checklist/<uuid:pk>/toggle/",
        views.ChecklistItemToggle.as_view(),
