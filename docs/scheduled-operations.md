...
> del día y no una foto tomada antes de que corrieran. Y **es el único que hay
> que instalar con prioridad**, porque es el que avisa cuando cualquiera de los
> otros deja de correr — sin él, un timer caído se descubre entrando a mirar el
> centro de administración, que es lo que nadie hace cuando todo parece bien.
>
> Lo que **no** puede hacer, y conviene tenerlo claro: si la VM está apagada,
